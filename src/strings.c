...
const u8 gText_MenuUseHM[] = _("USE HM");
...
const u8 gText_HMItemNotInBag[] = _("That HM isn't in your Bag.");
const u8 gText_HMMenuNeedBadge[] = _("You need that BADGE first.");
...
const u8 gStartMenuDesc_UseHM[] = _("Use a Hidden Machine you're carrying\nwithout teaching it to a POKéMON.");

...
// Maps FIELD_MOVE_FLASH..FIELD_MOVE_WATERFALL to the HM item that unlocks it.
// Doesn't line up with ITEM_HM01..ITEM_HM07 order (those are numbered by
...
// Bag (not PC) are the only requirements.
